...
INSERT INTO CUSTOMER_TBL(CUSTOMER_NO, CUSTOMER_NAME, ADDRESS, PHONE) VALUES(CUSTOMER_SEQ.NEXTVAL, '박지성', '영국', '000-000-000');
INSERT INTO CUSTOMER_TBL(CUSTOMER_NO, CUSTOMER_NAME, ADDRESS, PHONE) VALUES(CUSTOMER_SEQ.NEXTVAL, '김연아', '대한민국', '111-111-111');
INSERT INTO CUSTOMER_TBL(CUSTOMER_NO, CUSTOMER_NAME, ADDRESS, PHONE) VALUES(CUSTOMER_SEQ.NEXTVAL, '장미란', '대한민국', '222-222-222');
INSERT INTO CUSTOMER_TBL(CUSTOMER_NO, CUSTOMER_NAME, ADDRESS, PHONE) VALUES(CUSTOMER_SEQ.NEXTVAL, '추신수', '미국', '333-333-333');
INSERT INTO CUSTOMER_TBL(CUSTOMER_NO, CUSTOMER_NAME, ADDRESS, PHONE) VALUES(CUSTOMER_SEQ.NEXTVAL, '박세리', '대한민국', NULL);
COMMIT;
...
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1000, 1, 1, '20/07/01');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1000, 3, 2, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1001, 5, 1, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1002, 6, 2, '20/07/04');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1003, 7, 3, '20/07/05');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1000, 2, 5, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1003, 8, 2, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1002, 10, 2, '20/07/08');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1001, 10, 1, '20/07/09');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_NO, AMOUNT, ORDER_DATE) VALUES(TO_CHAR(SYSDATE, 'YYMMDD-') || ORDER_SEQ.NEXTVAL, 1002, 6, 4, '20/07/10');
