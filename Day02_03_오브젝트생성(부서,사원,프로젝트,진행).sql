...
CREATE TABLE EMPLOYEE_TBL (
    ...
    CONSTRAINT FK_EMP_DEP FOREIGN KEY(DEPT_NO) REFERENCES DEPARTMENT_TBL(DEPT_NO)
);
...
CREATE TABLE PROCEEDING_TBL (
    ...
    CONSTRAINT FK_PROCEED_EMP FOREIGN KEY(EMP_NO) REFERENCES EMPLOYEE_TBL(EMP_NO),
    CONSTRAINT FK_PROCEED_PJT FOREIGN KEY(PJT_NO) REFERENCES PROJECT_TBL(PJT_NO)
);
