...
-- 학번, 학생 이름, 수강 신청한 과목 이름을 조회 하시오.
SELECT S.S_NO, S.S_NAME, C.C_NAME
  FROM STUDENT_TBL S INNER JOIN ENROLL_TBL E
    ON S.S_NO = E.S_NO INNER JOIN COURSE_TBL C  -- FK(DRIVEN): STUDENT_TBL+ENROLL_TBL | PK(DRIVE): COURSE_TBL
    ON E.C_NO = C.C_NO;
...
-- 모든 교수들의 교수 이름, 교수 전공, 강의 이름을 조회 하시오
